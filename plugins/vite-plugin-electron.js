...
var acorn = /*@__PURE__*/getDefaultExportFromCjs(acorn$1.exports);

const extensions = ['.js', '.jsx', '.ts', '.tsx', '.vue'];
/** node.js builtins module */
const builtins = () => module$1.builtinModules.filter(x => !/^_|^(internal|v8|node-inspect)\/|\//.test(x));

/**
 * An vite plugin for electron integration.
 */
function electronEsm2cjs(options) {
    if (options.disabled)
        return;
    const opts = {
    ...
    return {
        ...
        config(conf, env) {
            ...
            const { exclude, ...optimizeDepsOmmit } = optimizeDeps !== null && optimizeDeps !== void 0 ? optimizeDeps : {};
            const { rollupOptions, ...buildOmmit } = build !== null && build !== void 0 ? build : {};
            const { external, output, ...rollupOptionsOmmit } = rollupOptions !== null && rollupOptions !== void 0 ? rollupOptions : {};
            const _config = {
                optimizeDeps: {
                    exclude: ["electron", ...(exclude !== null && exclude !== void 0 ? exclude : [])],
                    ...optimizeDepsOmmit,
                },
                build: {
                    rollupOptions: {
                        external: Array.isArray(external) || typeof external === "undefined"
                            ? ["electron", ...builtins(), ...(external !== null && external !== void 0 ? external : [])]
                            : external,
        ...
        transform(code, id) {
            const parsed = path__default['default'].parse(id);
            ...
            node.body.reverse().forEach((item) => {
                if (item.type !== "ImportDeclaration")
                    return;
                if (!opts.excludes.includes(item.source.value))
                    return; // 跳过不要转换的模块
...
module.exports = electronEsm2cjs;
